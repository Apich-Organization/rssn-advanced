...
RssnStatus rssn_gpu_compile_wgsl(DagBuilder *aBuilder,
                                 uint32_t aRoot,
...
RssnStatus rssn_gpu_execute_batch(GpuExecutor *aExecutor,
                                  const char *aWgslSrc,
                                  size_t aNRows,
                                  const double *const *aVarsCols,
                                  uint32_t aNVars,
...
void rssn_gpu_executor_free(GpuExecutor *aExecutor)
;
...
GpuExecutor *rssn_gpu_executor_new()
;
...
RssnStatus rssn_shape_dims(Shape *aShape,
...
void rssn_shape_free(Shape *aShape)
;
...
Shape *rssn_shape_new(const size_t *aDims,
                      uint32_t aNDims)
;
...
RssnStatus rssn_shape_numel(Shape *aShape,
                            size_t *aOutNumel)
;
...
RssnStatus rssn_shape_rank(Shape *aShape,
                           uint32_t *aOutRank)
;
...
Strides *rssn_shape_row_major_strides(Shape *aShape)
;
...
RssnStatus rssn_strides_as_slice(Strides *aStrides,
...
RssnStatus rssn_strides_flat_index(Strides *aStrides,
                                   const size_t *aIdx,
                                   uint32_t aNIdx,
                                   size_t *aOutFlatIdx)
;
...
void rssn_strides_free(Strides *aStrides)
;
...
void rssn_tensor_view_free(TensorView *aView)
;
...
RssnStatus rssn_tensor_view_get(TensorView *aView,
                                const size_t *aIdx,
                                uint32_t aNIdx,
                                double *aOutVal)
;
...
void rssn_tensor_view_mut_free(TensorViewMut *aViewMut)
;
...
RssnStatus rssn_tensor_view_mut_get(TensorViewMut *aViewMut,
                                    const size_t *aIdx,
                                    uint32_t aNIdx,
                                    double *aOutVal)
;
...
TensorViewMut *rssn_tensor_view_mut_new(double *aData,
                                        size_t aNData,
                                        Shape *aShape,
...
RssnStatus rssn_tensor_view_mut_set(TensorViewMut *aViewMut,
                                    const size_t *aIdx,
                                    uint32_t aNIdx,
                                    double aVal)
;
...
TensorView *rssn_tensor_view_new(const double *aData,
                                 size_t aNData,
                                 Shape *aShape,
                                 size_t aStorageOffset)
;
