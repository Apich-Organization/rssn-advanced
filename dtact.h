...
enum RssnStatus rssn_dag_compile_with_ctx(void *aCtx,
                                          struct DagBuilder *aBuilder,
                                          uint32_t aRoot,
                                          void **aOutFn)
;
...
enum RssnStatus rssn_dag_compile_with_opts(void *aCtx,
                                           struct DagBuilder *aBuilder,
                                           uint32_t aRoot,
                                           const void *aOpts,
                                           void **aOutFn)
...
void *rssn_jit_context_new(void)
;
...
enum RssnStatus rssn_jit_register_fn_1(struct RssnJitContext *aCtx,
                                       uint32_t aFnId,
                                       struct Option_RssnCustomFn1 aFunc)
;
...
enum RssnStatus rssn_jit_register_fn_1(void *aCtx,
                                       uint32_t aFnId,
                                       double (*aFunc)(double))
;
...
enum RssnStatus rssn_jit_register_fn_2(struct RssnJitContext *aCtx,
                                       uint32_t aFnId,
                                       struct Option_RssnCustomFn2 aFunc)
;
...
enum RssnStatus rssn_jit_register_fn_2(void *aCtx,
                                       uint32_t aFnId,
                                       double (*aFunc)(double,
                                                       double))
;
...
enum RssnStatus rssn_jit_register_fn_3(struct RssnJitContext *aCtx,
                                       uint32_t aFnId,
                                       struct Option_RssnCustomFn3 aFunc)
;
...
enum RssnStatus rssn_jit_register_fn_3(void *aCtx,
                                       uint32_t aFnId,
                                       double (*aFunc)(double,
                                                       double,
                                                       double))
