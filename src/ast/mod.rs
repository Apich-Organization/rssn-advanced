...
pub trait AstVisitor {
    ...
    fn visit_variable(&mut self, _idx: usize, _sym_id: crate::dag::symbol::SymbolId, _dag_id: crate::dag::node::DagNodeId) {}
    ...
    fn visit_operator(&mut self, _idx: usize, _op: crate::dag::symbol::OpKind, _children: &AstChildList, _dag_id: crate::dag::node::DagNodeId) {}
    /// Called for each function-call node.
    fn visit_function(&mut self, _idx: usize, _fn_id: crate::dag::symbol::FnId, _children: &AstChildList, _dag_id: crate::dag::node::DagNodeId) {}
}
...
mod tests {
    ...
    fn walk_counts_node_kinds() {
        ...
        struct Counter { vars: usize, consts: usize, ops: usize }
        impl AstVisitor for Counter {
            fn visit_variable(&mut self, _idx: usize, _sym_id: crate::dag::symbol::SymbolId, _dag_id: crate::dag::node::DagNodeId) { self.vars += 1; }
            fn visit_constant(&mut self, _idx: usize, _val: f64, _dag_id: crate::dag::node::DagNodeId) { self.consts += 1; }
            fn visit_operator(&mut self, _idx: usize, _op: crate::dag::symbol::OpKind, _children: &AstChildList, _dag_id: crate::dag::node::DagNodeId) { self.ops += 1; }
        }
        let mut counter = Counter { vars: 0, consts: 0, ops: 0 };
