# Code of Conduct: rssn-advanced

## 1. Introduction and Purpose

This Code of Conduct (CoC) outlines the minimum standards for acceptable behavior for all contributors, maintainers, and participants in the **rssn-advanced** project, across all platforms including GitHub, Codeberg, and any related communication channels.
...
We fully respect all copyright notices from the original developers. All code and documentation contributed to **rssn-advanced** must maintain proper attribution and adhere to the licensing terms defined for the project.
...
* **For Security Issues:** Contact **security@apich.org** or file a private issue report if available on the platform.
...
By participating in the **rssn-advanced** project, you agree to abide by this Code of Conduct.
