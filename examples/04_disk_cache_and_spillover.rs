...
fn main() {
    ...
    println!("  Node 'x' frequency             : {}", hotspots.get_frequency(id_x));
    println!("  Node 'y' frequency             : {}", hotspots.get_frequency(id_y));
    println!("  Node 'constant' frequency      : {}\n", hotspots.get_frequency(id_c));
    ...
    println!("  Restored Hot node value/kind   : {:?}", restored_node.kind);
